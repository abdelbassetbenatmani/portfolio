...
const About = () => {
  ...
  return (
    <div id="about" className="py-16 w-full gredient overflow-hidden">
      <div className="container relative mx-auto px-3 xl:px-14 gap-x-10 h-full flex justify-between items-center text-white">
        <Effect
        ...
        />
        <Effect
          className="absolute -left-40 bottom-0 hidden lg:block"
          src="/effect-2.svg"
          width={400}
          height={400}
          alt="effect"
        ...
        <div className="relative hidden lg:block lg:min-w-[450px] lg:min-h-[450px] xl:min-w-[650px] xl:min-h-[650px] ">
          <Image
            src="/about-me.png"
            fill
            alt="about"
        ...
        <div className="z-50">
          ...
          <h1 className="text-white uppercase my-3 text-4xl  lg:leading-normal font-bold">
            I AM AVAILABLE FOR <span className="text-theme">web development</span> PROJECTS
          </h1>
          <p>
            I am a full-stack web developer with a passion for creating interactive and responsive web
            applications. I have experience working with JavaScript, Next.js, React, Redux, Node.js, Express,
            PostgreSQL, MongoDB, Drizzle, HTML, CSS, and Git. As a quick learner, I am always eager to expand
            my knowledge and skill set. I thrive in team environments and look forward to collaborating with
      ...
      <div className="container relative mx-auto px-3 xl:px-14 mt-10">
        <h1 className="text-white uppercase my-3 text-4xl lg:leading-normal font-bold text-center">
          My skills
        </h1>
        <div className="flex items-center gap-8 flex-wrap justify-center">
            ...
            svg={
              <svg viewBox="0 0 128 128" width="100px" height="100px">
                ...
                <path
                  ...
                  clipRule="evenodd"
                  fill="#4FAA41"
                  d="M64.792 62.527c-.09 2.278-.176 4.557-.273 6.835-.027.634-.084 1.266-.128 1.898l-.584.221c-1.298-3.821-2.597-7.602-3.867-11.392-2.101-6.271-4.176-12.551-6.274-18.824a3423.013 3423.013 0 00-5.118-15.176c-.081-.236-.311-.422-.471-.631l3.74-6.877c.129.223.298.432.379.672 1.73 5.12 3.457 10.241 5.169 15.367 2.228 6.67 4.441 13.343 6.667 20.014.089.266.235.512.375.811l.512-.596-.127 7.678z"></path>
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  fill="#4AA73C"
                  d="M48.076 25.458c.161.209.391.395.471.631a3379.774 3379.774 0 015.118 15.176c2.098 6.273 4.173 12.553 6.274 18.824 1.27 3.79 2.569 7.57 3.867 11.392l.584-.221-.131 1.854-.119.427c-.203 2.029-.374 4.062-.622 6.087-.124 1.015-.389 2.011-.59 3.015-.151-.219-.363-.418-.445-.661-4.177-12.449-8.34-24.903-12.509-37.354a3010.791 3010.791 0 00-4.004-11.879c-.068-.201-.26-.359-.394-.537l2.5-6.754z"></path>
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  fill="#57AE47"
                  d="M64.918 54.849l-.512.596c-.14-.299-.286-.545-.375-.811-2.226-6.671-4.439-13.344-6.667-20.014a4618.057 4618.057 0 00-5.169-15.367c-.081-.24-.25-.449-.379-.672l4.625-6.084c.146.194.354.367.429.586 1.284 3.76 2.556 7.523 3.822 11.289 1.182 3.518 2.346 7.04 3.542 10.552.08.235.359.401.545.601l.01.798.129 18.526z"></path>
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  fill="#60B24F"
                  d="M64.779 35.525c-.187-.199-.465-.365-.545-.601-1.195-3.512-2.36-7.034-3.542-10.552a2495.581 2495.581 0 00-3.822-11.289c-.075-.219-.283-.392-.429-.586 1.504-1.473 2.961-2.999 4.526-4.404 1.391-1.248 2.509-2.586 2.561-4.559l.11-.393.396.998c-.01.504-.055 1.01-.022 1.512.057.873.198 1.742.237 2.615.073 1.625.108 3.253.141 4.88.053 2.618.101 5.237.133 7.856l.137 12.554c.01.657.079 1.313.119 1.969z"></path>
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  fill="#A9AA88"
                  d="M62.929 82.642c.201-1.004.466-2 .59-3.015.248-2.024.419-4.058.622-6.087l.051-.008.05.009a31.65 31.65 0 001.065 7.516c-.135.178-.324.335-.396.535-.555 1.566-1.079 3.145-1.637 4.71-.076.214-.29.381-.439.568l-.571-1.96.665-2.268z"></path>
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  fill="#B6B598"
                  d="M62.835 86.871c.149-.188.363-.354.439-.568.558-1.565 1.082-3.144 1.637-4.71.071-.2.261-.357.396-.535l.959 2.104c-.189.268-.451.511-.556.81l-1.836 5.392c-.076.217-.333.369-.507.552l-.532-3.045z"></path>
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  fill="#C2C1A7"
                  d="M63.367 89.915c.173-.183.431-.335.507-.552l1.836-5.392c.104-.299.367-.542.556-.81l.928.791c-.448.443-.697.955-.547 1.602l-.282.923c-.128.158-.314.296-.377.477-.641 1.836-1.252 3.682-1.898 5.517-.082.232-.309.415-.468.621l-.255-3.177z"></path>
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  fill="#CECDB7"
                  d="M63.621 93.091c.16-.206.387-.389.468-.621.646-1.835 1.258-3.681 1.898-5.517.063-.181.249-.318.377-.477l-.389 4.236c-.104.12-.254.225-.304.364l-1.294 3.708c-.091.253-.265.479-.401.716-.121-.158-.337-.311-.347-.475-.038-.642-.011-1.289-.008-1.934z"></path>
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  fill="#DBDAC7"
                  d="M63.977 95.501c.136-.237.31-.463.401-.716l1.294-3.708c.05-.14.201-.244.304-.364l.01 2.78-.931 2.387-1.078-.379z"></path>
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  fill="#EBE9DC"
                  d="M65.055 95.88l.931-2.387.192 2.824-1.123-.437z"></path>
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  fill="#CECDB7"
          ...
          <SkillsCard
            svg={
              <svg viewBox="0 0 128 128" width="100px" height="100px" fill="#8912FC">
