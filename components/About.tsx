      ...
      <div className="container relative mx-auto px-3 xl:px-14 gap-x-10 h-full flex justify-between items-center text-white">
        ...
        <div className="z-50">
          ...
          <h1 className="text-white uppercase my-3 text-4xl  lg:leading-normal font-bold">
            I AM AVAILABLE FOR{" "}
            <span className="text-theme">web development</span> PROJECTS
          </h1>
          <p>
            I am a full-stack web developer with a passion for creating
            interactive and responsive web applications. I have experience
            working with JavaScript, Next.js, React, Redux, Node.js, Express,
            PostgreSQL, MongoDB, Drizzle, HTML, CSS, and Git. As a quick
            learner, I am always eager to expand my knowledge and skill set. I
            thrive in team environments and look forward to collaborating with
